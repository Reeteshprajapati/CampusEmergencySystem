...
public class Location {
    ...
    public Location(Long id, String building, String area, String floor, String room, Double latitude, Double longitude, LocalDateTime createdAt) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Location build() { return new Location(id, building, area, floor, room, latitude, longitude, createdAt); }
    }
}
